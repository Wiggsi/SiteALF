...
/**
 * @Route("/Gendarmerie/Messages")
 */
class GDPostController extends Controller {
    /**
     * @Route("", name="gd_post", methods="GET")
     */
    ...
    /**
     * @Route("/new", name="gd_post_new", methods="GET|POST", requirements={"id"="\d+"})
     */
    public function new(Request $request): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('gd_post_show', ['id' => $post->getId()]);
        }
    ...
    /**
     * @Route("/{id}", name="gd_post_show", methods="GET", requirements={"id"="\d+"})
     */
    ...
    /**
     * @Route("/{id}/edit", name="gd_post_edit", methods="GET|POST",
     *                      requirements={"id"="\d+"})
     */
    public function edit(Request $request, Post $post)
    {
        if (!$this->getUser()->getGendarme()->isChef() and $this->getUser() != $post->getAuthor()) {
    ...
    /**
     * @Route("/{id}", name="gd_post_delete", methods="DELETE", requirements={"id"="\d+"})
     */
    public function delete(Request $request, Post $post)
    {
        if ($this->getUser() != $post->getAuthor() and !$this->getUser()->getGendarme()->isChef()) {
        ...
        return $this->redirectToRoute('gd_post');
    }

    /**
     * @Route("/{category}", name="gd_post_category", methods="GET")
     */
    ...
    /**
     * @Route("/{idPost}/newMessage", name="gd_post_message_new", methods="POST", requirements={"idPost"="\d+"})
     */
    public function newMessage($idPost, Request $request, PostRepository $rep)
    {
        ...
        if ($content != '' and $content != NULL) {
            ...
            return $this->redirectToRoute('gd_post_show', ['id' => $idPost]);
        }
    ...
    /**
     * @Route("/{idPost}/messages/{id}", name="gd_post_message_delete", methods="DELETE", requirements={"idPost"="\d+",
     *     "id"="\d+"})
     */
    public function deleteMessage(Request $request, Message $message, $idPost)
    {
        if ($this->getUser() != $message->getAuthor() and !$this->getUser()->getGendarme()->isChef()) {
